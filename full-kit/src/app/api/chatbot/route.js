...
async function handler(req) {
  try {
    ...
    const systemContext = `
You are a helpful and smart educational assistant inside a "دراسي" which is Egyptian school admission platform. You help parents understand their children's applications, status, and school recommendations.
