        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {children.map((child) => (
            ...
            >
              ...
              <div
                key={child._id}
                className="relative rounded-xl overflow-hidden shadow-xl text-white group transition-transform hover:scale-[1.015]"
              >
                ...
                <div className="absolute inset-0">
                  {child.profileImage?.url ? (
                    <div
                      ...
                      style={{
                        backgroundImage: `url(${child.profileImage.url})`,
                      }}
                    />
                  ) : (
                    <div className="h-full w-full bg-gradient-to-br from-purple-600 via-pink-500 to-blue-500" />
                  )}
                </div>
